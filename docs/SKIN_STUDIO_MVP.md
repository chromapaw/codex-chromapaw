...
- independent subject-placement, subject-display-priority, resolved content-layout, recomposition-state, local-surface protection, and scene-fidelity metadata;
